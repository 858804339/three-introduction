...
const material = new THREE.MeshStandardMaterial({ color: "#ffff00", map: text, alphaMap: textalpha, transparent: true, side: THREE.DoubleSide, aoMap: textao, aoMapIntensity: 0.8 });
